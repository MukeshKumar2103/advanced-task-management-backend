...
const verifyEmail = async (req, res) => {
  ...
  try {
    ...
    const isUserEmailVerificationStatusUpdated =
...
const signIn = async (req, res) => {
  ...
  try {
    ...
    //   session,
    // });
    const isUserExist = await userRepository.checkUserExist(email, session);
...
module.exports = { signUp, verifyEmail, verifyToken, signIn };
